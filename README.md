...
对应文件：[index.html](/e:/code/pt-web/index.html)

### PC 端平台页

![PC 页预览](./docs/assets/preview-pc.svg)

对应文件：[platform-pc.html](/e:/code/pt-web/platform-pc.html)

### 移动端 H5 页

![移动端预览](./docs/assets/preview-mobile.svg)

对应文件：[platform-mobile.html](/e:/code/pt-web/platform-mobile.html)
...
直接在浏览器中打开 [index.html](/e:/code/pt-web/index.html) 即可查看页面效果，也可以使用 VS Code 的 Live Server 等静态服务工具进行预览。
